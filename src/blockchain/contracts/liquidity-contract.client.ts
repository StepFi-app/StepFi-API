  ...
  async buildUnsignedXdr(
    ...
    try {
      ...
      const tx = new StellarSdk.TransactionBuilder(sourceAccount, {
        ...
        .addOperation(contract.call(method, userArg, amountArg))
        .setTimeout(300)
        .build();
      ...
      if (StellarSdk.SorobanRpc.Api.isSimulationError(simulation)) {
        ...
        this.logger.error(`${method} simulation failed: ${errorMsg}`);
      ...
      this.logger.error(`Failed to build ${method} transaction: ${(error as Error).message}`);
      throw error;
    }
  }
